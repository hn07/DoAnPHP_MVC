    ...
    <div class="content">
        <div class="section group">
            <table class="tblone">
                ...
                ?>
                        <tr>
                            <td colspan="3"><h2 style="font-size: 28px;" href="editprofile.php">My Profile</h2></td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td style="display: flex; justify-content: left;"><?php echo $result['address_zipcode'] ?></td>
                        </tr>
                        <tr>
